...
public class ModAttributes {
    public static final DeferredRegister<Attribute> ATTRIBUTES =
            DeferredRegister.create(ForgeRegistries.ATTRIBUTES, ZoeIsntCyberpunk.MOD_ID);

    public static final RegistryObject<Attribute> PLATING = ATTRIBUTES.register("plating", () ->
